# Example Platform Plugin for GrayJay
...
![QR Code](https://github.com/grayjay-sources/example/raw/main/qrcode.png)

Or click [here](https://github.com/grayjay-sources/example) to install manually.
...
- **Author**: Bluscream
- **Repository**: https://github.com/grayjay-sources/example
...
For issues and questions, please use the [GitHub Issues](https://github.com/grayjay-sources/example/issues) page.
